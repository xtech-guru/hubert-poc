    ...
    <div className="page-content">
      <article className="container">
        <header className="content padded-content">
          <h1>
            <a href="https://www.sorpetaler.de/hubert/about/"></a>
          </h1>
        </header>
        <div className="content padded-content">
          ...
          <p>
            ...
            neuesten Trends rund um den Werkstoff Holz, über aktuelle
            Entwicklungen in der Architektur und nachhaltiges Bauen und Wohnen.
            Wir liefern Interviews mit spannenden Persönlichkeiten aus der
            Branche und bieten Tipps und Tricks für die ideale Pflege und
            Behandlung von Holz.{" "}
          </p>
          ...
          Pflege und zum Streichen von Holzfenstern.<p></p>
          ...
          <p>
            ...
            Holz-Aluminium-Fenster sowie Haustüren und Terrassentüren aus Holz
            und Holz-Aluminium. Unsere Liebe zum Werkstoff Holz wollen wir mit
            Hubert weitertragen. Wir wissen von vielen anderen, dass sie diese
            Liebe zum Werkstoff Holz teilen. Für all jene ist das Magazin.
          </p>
          <p>
            Der Name unseres Magazins kommt dabei nicht von ungefähr:
            Schreinermeister Hubert Appelhans, seines Zeichens Gründer der
            Sorpetaler Fensterbau GmbH, übernahm die Landschreinerei Appelhans
            im Jahr 1947 und war immer davon überzeugt, dass Holz das beste und
